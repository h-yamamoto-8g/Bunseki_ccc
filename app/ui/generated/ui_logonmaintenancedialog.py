...
################################################################################
## Form generated from reading UI file 'LogonMaintenanceDialog.ui'
##
...
class Ui_LogonMaintenanceDialog(object):
    def setupUi(self, LogonMaintenanceDialog):
        if not LogonMaintenanceDialog.objectName():
            LogonMaintenanceDialog.setObjectName(u"LogonMaintenanceDialog")
        LogonMaintenanceDialog.resize(294, 144)
        self.verticalLayout = QVBoxLayout(LogonMaintenanceDialog)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.widget_message = QWidget(LogonMaintenanceDialog)
        ...
        self.widget_input = QWidget(LogonMaintenanceDialog)
        ...
        self.widget_actions = QWidget(LogonMaintenanceDialog)
        ...
        self.retranslateUi(LogonMaintenanceDialog)

        QMetaObject.connectSlotsByName(LogonMaintenanceDialog)
    # setupUi

    def retranslateUi(self, LogonMaintenanceDialog):
        LogonMaintenanceDialog.setWindowTitle(QCoreApplication.translate("LogonMaintenanceDialog", u"Bunseki - Maintenance Mode - Logon", None))
        self.label_message.setText(QCoreApplication.translate("LogonMaintenanceDialog", u"\u30e6\u30fc\u30b6\u30fcID\u3068\u30d1\u30b9\u30ef\u30fc\u30c9\u3092\u5165\u529b\u3057\u3066\u304f\u3060\u3055\u3044\u3002", None))
        self.lbl_user_id.setText(QCoreApplication.translate("LogonMaintenanceDialog", u"\u30e6\u30fc\u30b6\u30fc", None))
        self.lbl_password.setText(QCoreApplication.translate("LogonMaintenanceDialog", u"\u30d1\u30b9\u30ef\u30fc\u30c9", None))
        self.btn_logon.setText(QCoreApplication.translate("LogonMaintenanceDialog", u"\u30ed\u30b0\u30aa\u30f3", None))
        self.btn_cancel.setText(QCoreApplication.translate("LogonMaintenanceDialog", u"\u30ad\u30e3\u30f3\u30bb\u30eb", None))
    # retranslateUi
